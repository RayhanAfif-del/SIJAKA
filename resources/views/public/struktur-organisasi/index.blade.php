    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        @if ($struktur->isNotEmpty())
            ...
            <div class="text-center mb-12" data-aos="fade-up">
                <span class="inline-block px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-wider mb-3">
                    Tim Pengurus
                </span>
                ...
                <p class="text-gray-500 mt-3 max-w-2xl mx-auto">
                    Setiap anggota tim kami berkomitmen untuk memberikan layanan terbaik dalam menjembatani siswa dan alumni dengan dunia kerja.
                </p>
            </div>
            ...
            @if ($struktur->count() > 1)
                ...
                {{-- Pengurus pertama ditampilkan sebagai card besar --}}
                        ...
                        <div class="group bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 text-white text-center shadow-xl shadow-blue-600/20 relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="relative w-28 h-28 mx-auto mb-5">
                                    ...
                                    <div class="absolute inset-0 bg-white/20 rounded-full transform transition-transform duration-300"></div>
                                    ...
                                    <div class="relative w-full h-full rounded-full overflow-hidden ring-4 ring-white/30 shadow-lg">
                                        ...
                                        @if ($firstItem->foto)
                                            ...
                                            <img
                                                src="{{ Storage::url($firstItem->foto) }}"
                                        ...
                                        @else
                                            ...
                                            <div class="w-full h-full flex items-center justify-center text-white font-bold text-2xl bg-blue-500/50">
                                                {{ collect(explode(' ', $firstItem->nama))
                ...
                {{-- Pengurus berikutnya: 1 - 1 - 1 - 3 --}}
                <div
                    class="grid grid-cols-1 sm:grid-cols-6 gap-6 max-w-5xl mx-auto"
                >

                    @foreach ($struktur->skip(1) as $index => $item)

                        @php
                            $delay = min(($index + 1) * 50, 400);

                            /*
                            * Index dimulai dari 0 karena menggunakan skip(1)
                            *
                            * index 0 = pengurus ke-2
                            * index 1 = pengurus ke-3
                            * index 2 = pengurus ke-4
                            *
                            * Pola:
                            * 0 -> 6 kolom
                            * 1 -> 6 kolom
                            ...
                            */
                            ...
                            $isSingleItem = $index < 3;
                        @endphp


                        <div
                            class="group bg-white rounded-2xl border border-blue-600 p-6 text-center transition-all duration-300
                            {{ $isSingleItem
                                ? 'sm:col-span-6 max-w-md w-full mx-auto'
                                : 'sm:col-span-2'
                            }}"
                            data-aos="fade-up"
            ...
            <div class="py-20 text-center" data-aos="fade-up">
                ...
                <div class="max-w-md mx-auto">
                    ...
                    <div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-5">
                        ...
                        >
                            <path
                                ...
                                stroke-width="1.5"
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20v-2a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z"
                            />
                        </svg>
                    ...
                    <p class="text-gray-500 leading-relaxed">
                        Struktur organisasi BKK SIJAKA sedang dalam proses penyusunan.
                        Silakan kunjungi kami kembali nanti.
                    </p>
