<x-layouts.public title="Kontak">
    ...
    <section class="bg-blue-800 text-white">
        <div class="max-w-7xl mx-auto px-4 py-10">
            ...
            <p class="text-blue-200 text-sm max-w-2xl">Hubungi tim BKK SIJAKA SMK N 1 Bangsri untuk informasi lebih lanjut seputar layanan karier.</p>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 py-14 grid lg:grid-cols-2 gap-10">
        <div class="space-y-6">
            <div class="flex items-start gap-4 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                <span class="w-11 h-11 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed">{{ $kontak->alamat }}</p>
                </div>
            </div>
            <div class="flex items-start gap-4 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                <span class="w-11 h-11 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center flex-shrink-0">
            ...
            <div class="flex flex-wrap gap-3 pt-2">
                @if ($kontak->facebook)
                    <a href="{{ $kontak->facebook }}" target="_blank" class="w-11 h-11 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-100 transition" aria-label="Facebook">
                ...
                @endif
                @if ($kontak->instagram)
                    <a href="{{ $kontak->instagram }}" target="_blank" class="w-11 h-11 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-100 transition" aria-label="Instagram">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                @endif
                @if ($kontak->youtube)
                    <a href="{{ $kontak->youtube }}" target="_blank" class="w-11 h-11 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-100 transition" aria-label="YouTube">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
