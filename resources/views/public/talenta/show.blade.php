    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        <div class="grid lg:grid-cols-[1fr_340px] gap-8 items-start">
            ...
            <aside class="lg:sticky lg:top-6 space-y-6">
                ...
                {{-- Back Link --}}
                <a href="{{ route('talenta.index') }}" class="flex items-center justify-center gap-2 w-full py-3 text-sm font-semibold text-slate-600 hover:text-[#024CD4] transition-colors">
