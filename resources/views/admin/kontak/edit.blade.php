                    ...
                    <div class="p-5 sm:p-6 space-y-5">
                        ...
                        <div class="grid sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                @error('telepon') <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>{{ $message }}</p> @enderror
                            </div>
                        </div>
                ...
                <div class="bg-white border border-slate-200/70 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 sm:p-6">
                        <div>
                            ...
                            @error('map_link') <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>{{ $message }}</p> @enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-slate-200/70 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 sm:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            @error('instagram') <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="grid sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label class="flex items-center gap-1.5 text-sm font-medium text-slate-700 mb-1.5">
                                    <span class="w-5 h-5 rounded bg-blue-600 flex items-center justify-center text-white">
                                ...
                                <input type="url" name="facebook" value="{{ old('facebook', $kontak->facebook) }}"
                                    class="w-full rounded-lg border-slate-200 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 text-sm transition"
                                    placeholder="https://facebook.com/username">
                                @error('facebook') <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>{{ $message }}</p> @enderror
                            </div>

                            {{-- YouTube --}}
                            <div>
                                <label class="flex items-center gap-1.5 text-sm font-medium text-slate-700 mb-1.5">
                                    <span class="w-5 h-5 rounded bg-red-600 flex items-center justify-center text-white">
                                ...
                                <input type="url" name="youtube" value="{{ old('youtube', $kontak->youtube) }}"
                                    class="w-full rounded-lg border-slate-200 focus:border-red-600 focus:ring-2 focus:ring-red-600/20 text-sm transition"
                                    placeholder="https://youtube.com/@channel">
                                @error('youtube') <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>{{ $message }}</p> @enderror
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:sticky lg:top-5 space-y-4">
                    ...
                    <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            {{-- Social Media --}}
                            @if($kontak->instagram || $kontak->facebook || $kontak->youtube)
                                <div class="pt-4 border-t border-slate-100">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        @endif
                                        @if($kontak->facebook)
                                            <span class="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white" title="Facebook">
                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385h-3.047v-3.47h3.047v-2.642c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953h-1.513c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385c5.737-.9 10.126-5.864 10.126-11.854z"/></svg>
                                            </span>
                                        @endif
                                        @if($kontak->youtube)
                                            <span class="w-8 h-8 rounded-lg bg-red-600 flex items-center justify-center text-white" title="YouTube">
