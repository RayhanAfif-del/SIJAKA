    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <div class="flex items-center gap-2 text-xs text-slate-500 mb-2">
                ...
                <span class="text-slate-700 font-medium">Edit Mitra</span>
            </div>
            <h1 class="text-2xl font-semibold text-slate-900 tracking-tight">Edit Data Mitra</h1>
            <p class="text-sm text-slate-500 mt-1">Perbarui informasi akun perusahaan <span class="font-medium text-slate-700">{{ $mitra->nama_perusahaan }}</span>.</p>
        </div>
