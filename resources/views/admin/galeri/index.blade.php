                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center gap-1.5 pt-3 border-t border-slate-100">
                        <a href="{{ route('admin.galeri.edit', $primaryEdit) }}" 
                           class="table-action flex-1 text-blue-600 bg-blue-50 border-blue-200 hover:bg-blue-100 hover:border-blue-300"
                           title="Edit grup">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        ...
                        <button
                            type="button"
                            @click="$dispatch('open-stack-preview', { title: @js($item['judul']), date: @js(optional($item['tanggal'])->translatedFormat('d F Y')), kategori: @js($item['kategori']), items: @js($previewItems) })"
                            class="table-action flex-1 text-slate-600 bg-slate-50 border-slate-200 hover:bg-slate-100 hover:border-slate-300"
                        ...
                        <div class="relative flex-1">
                            <button
                                ...
                                class="table-action w-full text-red-600 bg-red-50 border-red-200 hover:bg-red-100 hover:border-red-300"
                                title="Hapus">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
