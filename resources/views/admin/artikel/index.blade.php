<x-layouts.admin title="Artikel">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <a href="{{ route('admin.artikel.create') }}" class="btn-primary w-full sm:w-auto justify-center">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <a href="{{ route('admin.artikel.edit', $item) }}" 
                                       class="table-action text-blue-600 bg-blue-50 border border-blue-200 hover:bg-blue-100 hover:border-blue-300"
                                       title="Edit artikel">
                                    ...
                                    <form method="POST" action="{{ route('admin.artikel.destroy', $item) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus artikel ini? Tindakan ini tidak dapat dibatalkan.')" class="inline">
                                        ...
                                        @method('DELETE')
                                        <button type="submit" 
                                                class="table-action text-red-600 bg-red-50 border border-red-200 hover:bg-red-100 hover:border-red-300"
                                                title="Hapus artikel">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
