<x-layouts.admin title="Tambah Struktur Organisasi">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <h1 class="text-2xl font-semibold text-slate-900 tracking-tight">Tambah Pengurus Baru</h1>
            <p class="text-sm text-slate-500 mt-1">Lengkapi data pengurus untuk ditampilkan di halaman struktur organisasi publik.</p>
        </div>
