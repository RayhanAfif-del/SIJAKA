<x-layouts.admin title="Profil BKK">
    ...
    <div class="admin-form-panel max-w-5xl">
            ...
            <div class="admin-form-grid">
                <div>
                    ...
                    <div class="grid gap-4 lg:grid-cols-[220px_1fr] lg:items-center">
                        <div class="h-40 rounded-xl border border-gray-200 bg-gray-50 overflow-hidden flex items-center justify-center">
                            @if ($profilBkk->gambar)
                ...
                <div class="admin-form-grid-2">
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="profil" rows="4" required
