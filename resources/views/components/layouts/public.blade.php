...
<body class="bg-slate-50 font-sans antialiased text-slate-800 flex flex-col min-h-screen overflow-x-clip" x-data="{ mobileMenu: false }">
                ...
                <nav class="hidden lg:flex items-center gap-1">
                    @php
                        $navLinks = [
                            ...
                            ['route' => 'talenta.index', 'label' => 'Talenta'],
    ...
    {{-- Main Content --}}
    <main class="flex-grow overflow-x-clip min-w-0">
        {{ $slot }}
    </main>
    ...
    @if ($whatsappNumber)
        <a
            ...
            class="fixed bottom-4 right-4 z-40 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-emerald-900/25 transition hover:scale-110 hover:bg-[#1ebe5d] focus:outline-none focus:ring-4 focus:ring-emerald-200 sm:bottom-7 sm:right-7"
        >
            <svg class="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
